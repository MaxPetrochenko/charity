...
export interface StakingNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface StakingNFT extends BaseContract {
  connect(runner?: ContractRunner | null): StakingNFT;
  ...
  createNFT: TypedContractMethod<[to: AddressLike], [bigint], "nonpayable">;
